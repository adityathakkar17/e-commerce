...
<head>
    ...
    <link href="{{asset('admin_assets/vendor/font-awesome-5/css/fontawesome-all.min.cs')}}" rel="stylesheet" media="all">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="{{asset('admin_assets/images/icon/logo.png')}}" alt="ProductMartAdmin">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="{{route('admin.auth')}}" method="post">
                                ...
                                <p style="text-align:center;">{{session('err')}}</p>
                                </div>
